...
const username = "offseckalki";
const socialMediaLinks = [
    {
        site: "LinkedIn",
        url: "https://linkedin.com/in/offseckalki",
    },
    {
        site: "Twitter",
        url: "https://twitter.com/offseckalki",
    },
    {
        site: "Hack The Box",
        url: "https://app.hackthebox.com/profile/880607",
    },
    {
        site: "Discord",
        url: "https://discordapp.com/users/offseckalki#3404",
    },
    {
    ...
    {
        site: "Github",
        url: "https://github.com/offseckalki",
    },
];
...
document.getElementById('toggleView').addEventListener('click', function() {
    ...
    var guiView = document.getElementById('guiView');
    ...
    if (terminalView.style.display === 'none') {
        ...
        toggleButton.textContent = 'Switch to GUI View';
    } else {
        terminalView.style.display = 'none';
        guiView.style.display = 'block';
        toggleButton.textContent = 'Switch to Terminal View';
    }
});

// Populate GUI with projects and social media links

document.addEventListener('DOMContentLoaded', function() {
    const socialMediaLinks = [
        { site: "LinkedIn", url: "https://linkedin.com/in/offseckalki" },
        { site: "Twitter", url: "https://twitter.com/offseckalki" },
        { site: "Hack The Box", url: "https://app.hackthebox.com/profile/880607" },
        { site: "Discord", url: "https://discordapp.com/users/offseckalki#3404" },
        { site: "X(Formerly Known as Twitter)", url: "https://twitter.com/offseckalki" },
        { site: "Github", url: "https://github.com/offseckalki" },
    ];
    ...
    fetch(`https://api.github.com/users/${username}/repos?type=owner&per_page=100&page=1`)
        .then(response => response.json())
        .then(repos => {
            repos.filter(repo => !repo.fork && !repo.archived).forEach(repo => {
    ...
    socialMediaLinks.forEach(link => {
        const listItem = document.createElement('li');
        listItem.innerHTML = `<a href="${link.url}" target="_blank">${link.site}</a>`;
